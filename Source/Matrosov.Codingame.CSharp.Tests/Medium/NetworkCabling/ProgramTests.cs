...
using System.IO;
using System.Linq;
using Matrosov.Codingame.CSharp.Medium.NetworkCabling;
using NUnit.Framework;

namespace Matrosov.Codingame.CSharp.Tests.Medium.NetworkCabling
{
    [TestFixture]
    public class ProgramTests
    {
        private static readonly string TestCasesDirectory = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Medium/NetworkCabling/TestCases");
